...
Main = React.createClass({
  ...
  defaultCode: "//Fibbo////Ignore this:#include <iostream>using namespace std;#define println(x) do { cout << x << endl; } while (0) #define print(x) do { cout << x; } while (0) int main() {    if (fibbonacci(2) == 1){        println(\"Passed test 1!\");    } else {        print(\"Test 1 failed: returned \");        print(fibbonacci(0));        println(\" instead of 1\");    }        if (fibbonacci(1) == 1){        println(\"Passed test 2!\");    } else {        print(\"Test 2 failed: returned \");        print(fibbonacci(1));        println(\" instead of 1\");    }    if (fibbonacci(10) == 55){        println(\"Passed test 3!\");    } else {        print(\"Test 3 failed: returned \");        print(fibbonacci(10));        println(\" instead of 55\");    }        return 0;}//   Challenge://   Calculate the nth fibbonacci number://int fibbonacci(int n){    //Write code here}",
